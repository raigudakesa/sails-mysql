...
/**
 * Functions for freeing/terminating a MariaDB connection when a query is complete.
 *
 * @type {Object}
 */
module.exports = {
  ...
  /**
   * Frees the MariaDB connection back into the pool.
   *
  ...
  /**
   * Terminates the MariaDB connection.
   *
   * @param  {MariaDBConnection}   conn
   * @param  {Function} cb
   */
