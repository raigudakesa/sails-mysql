...
var STRINGFILE = {
  noCallbackError: 'An error occurred in the MariaDB adapter, but no callback was specified to the spawnConnection function to handle it.'
};
...
module.exports = (function() {
  ...
  var adapter = {
    ...
    query: function(connectionName, collectionName, query, data, cb, noop, connection) {
      ...
      function __QUERY__(connection, cb) {
        ...
        // Run query
        log('MariaDB.query: ', query);

        if (data) {
          connection.query(query, data).then((res) => cb(null, res)).catch((err) => cb(err));
        }
        else {
          connection.query(query).then((res) => cb(null, res)).catch((err) => cb(err));
        }
    ...
    describe: function(connectionName, collectionName, cb, noop, connection) {
      ...
      function __DESCRIBE__(connection, cb) {
        ...
        // Run query
        log('MariaDB.describe: ', query);
        log('MariaDB.describe(pk): ', pkQuery);

        connection.query(query).then((schema) => {
          return connection.query(pkQuery).then((pkResult) => {
            ...
            return cb(null, normalizedSchema);
          }).catch((err) => {
            return cb(err);
          })
        }).catch((err) => {
    ...
    addAttribute: function (connectionName, collectionName, attrName, attrDef, cb, noop, connection) {
      ...
      function __ADD_ATTRIBUTE__(connection, cb) {
        ...
        // Run query
        log('MariaDB.addAttribute: ', query);
    ...
    removeAttribute: function (connectionName, collectionName, attrName, cb, noop, connection) {
      ...
      function __REMOVE_ATTRIBUTE__(connection, cb) {
        ...
        // Run query
        log('MariaDB.removeAttribute: ', query);
    ...
    create: function(connectionName, collectionName, data, cb, noop, connection) {
      ...
      function __CREATE__(connection, cb) {
        ...
        // Run query
        log('MariaDB.create: ', _query.query);
    ...
    createEach: function (connectionName, collectionName, valuesList, cb, noop, connection) {
      ...
      function __CREATE_EACH__(connection, cb) {
        ...
        async.eachSeries(valuesList, function (data, cb) {
          ...
          // Run query
          log('MariaDB.createEach: ', _query.query);

          connection.query(_query.query).then((results) => {
          ...
          $populateBuffers: function populateBuffers(options, next) {
            ...
            async.auto({
              ...
              processParent: function(next) {
                log('MariaDB.populateBuffers: ', _query.query[0]);

                client.query(_query.query[0])
                .then((result) => {
              ...
              processChildren: ['buildChildBuffers', function(resultsSoFar, next) {
                ...
                async.each(_query.query, function(q, next) {
                  ...
                  log('MariaDB.processChildren: ', qs);
    ...
    find: function(connectionName, collectionName, options, cb, noop, connection) {
      ...
      function __FIND__(connection, cb) {
        ...
        // Run query
        log('MariaDB.find: ', _query.query[0]);

        connection.query(_query.query[0])
        .then((result) => {
    ...
    count: function(connectionName, collectionName, options, cb, noop, connection) {
      ...
      function __COUNT__(connection, cb) {
        ...
        // Run query
        log('MariaDB.count: ', _query.query[0]);
    ...
    update: function(connectionName, collectionName, options, values, cb, noop, connection) {
      ...
      function __UPDATE__(connection, cb) {
        ...
        log('MariaDB.update(before): ', _query.query[0]);
        ...
        .then((result) => {
          ...
          // Run query
          log('MariaDB.update: ', _query.query);
          ...
          .then((result) => {
            ...
            // Run query
            log('MariaDB.update(after): ', _query.query[0]);
      ...
      function __DESTROY__(connection, cb) {
        ...
        async.auto({
          ...
          destroyRecords: ['findRecords', function(resultsSoFar, next) {
            log('MariaDB.destroy: ', _query.query);
  ...
  function handleQueryError (err) {
    ...
    if (err.code === 'ER_DUP_ENTRY') {
      ...
      // Manually parse the MariaDB error response and extract the relevant bits,
